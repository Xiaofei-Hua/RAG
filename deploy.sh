#!/bin/bash
# =============================================================================
# 领域自适应 RAG 智能问答平台 — Ubuntu 从零部署脚本
#
# 用法:
#   sudo ./deploy.sh                     # 完整部署
...
echo ""
echo -e "${BOLD}============================================${NC}"
echo -e "${BOLD}  领域自适应 RAG 智能问答平台 — Ubuntu 部署${NC}"
echo -e "${BOLD}============================================${NC}"
...
EMBEDDING_MODEL_PATH=${EMBEDDING_MODEL_PATH:-models/local_models/bge-m3}
...
MILVUS_DB_URI=./milvus_data.db
COLLECTION_NAME=${COLLECTION_NAME:-rag_knowledge_base}
